...
<div class="container">
   <div class="panel panel-primary">
      <div class="panel-body">
         <div class="row">
            <div class="col-md-6">
               <div class="form-group">
                  <label class="control-label">Locuri disponibile</label>
                  <input type="text" class="form-control" name="email" id="locuri">
               </div>
            </div>
            <div class='col-md-6'>
               <div class="form-group">
                  <label class="control-label">Alege data si ora plecarii</label>
         ...
         <input onclick="submitOferaCursa()" type="submit" class="btn btn-primary" value="Submit">
      </div>
   </div>
</div>
  ...
  <script>
      ...
      function initMap() {
        ...
        function createPuncte(form_data) {
        form_data = formatPath(form_data);
        console.log(form_data);
        var usr_id = "<?php echo $_SESSION['user_id']; ?>";
  		$.ajax({
          url: "http://localhost/Licienta/Punct/create.php?usr_id=" + usr_id,
          type: "POST",
  		...
  		function showPuncte() {
  		$.getJSON("http://localhost/Licienta/Punct/read.php", function(data) {
  			console.log(data);
  		});
  	}
      ...
      function submitOferaCursa(){ 
      	var date = $("#data").val();
      	var dates = date.split(" ");
      	var locuri = $("#locuri").val();
        var usr_id = "<?php echo $_SESSION['user_id']; ?>";
  		console.log(dates);
  		    var datess = dates[0];
        ...
        console.log(usr_id);
        $.ajax({
          url: "http://localhost/Licienta/Calatorie/update.php?usr_id=" + usr_id + "&data=" + res + "&locuri=" + locuri + "&ora=" + timess,
          type: "GET",
          success: function(result) {
             console.log("success");
          },
  		...
  		window.alert("Calatoria dumneavoastra a fost adaugata");
    }
