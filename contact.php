...
if (isset($_POST['send_contact'])) {
    ...
    $subiect = mysqli_real_escape_string($con, $_POST['subiect']);
		...
		$sql = "INSERT INTO contacteaza (contacteaza_nume, contacteaza_subiect, contacteaza_corp)
    VALUES ('".$_POST["nume"]."','".$_POST["mesaj"]."','".$_POST["subiect"]."')";
					...
					<div class="contact-form">
						<h1>Contact Us</h1>
							...
							<div  class="form-group group-coustume">
								...
								<input type="text" name="nume" class="form-control name-form" placeholder="Numele dumneavoastra">
								<input type="text" name="subiect" class="form-control subject-form" placeholder="Subiectul dumneavoastra">
								<textarea rows="7" cols="50" name="mesaj" class="form-control subject-form" placeholder="Mesajul dumneavoastra.."></textarea>
								<input name="send_contact" type="submit" class="btn btn-default btn-submit">
									</form>
							</div>
